        ...
        <div className="">
          ...
          {targetedProject && (
            <span className="font-NOTO text-md">
              ...
              받은 사람의 MetaMask Snap에 저장됩니다. 선물을 준 사람과 선물을
              받은 사람 모두를 보호하도록 설계된 에스크로 스마트 계약을 사용하는
              것입니다
            </span>
          )}
          {resultProject && (
            <div>
              <ul className="flex flex-col gap-3">
                <li>
                  ...
                  이용하여 프론트엔드와 백엔드를 구축 및 스마트 컨트랙트 상호
                  자용 확인
                </li>
                <li>
                  NextJS 아토믹 스타일의 components 구축 & TypeScript,
                  TailwindCSS CVA, CLSX 세팅
                </li>
                <li>
                  사용자 지갑과 구독을 관리하는 커스텀 Hook을 이용하여 지갑
                  연결.
                </li>
                <li>
