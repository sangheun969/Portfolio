        ...
        <div className="w-[700px] h-full">
          <span className="w-[590px] font-NOTO text-2xl flex flex-col mx-auto">
            ...
            <ul className="flex flex-col py-7 gap-2 font-['Tenada'] text-white">
              ...
              <li className="text-sm flex flex-col gap-3">
                <h1>
                  이 행사는 이더리움 생태계의 발전을 위한 아이디어를 공유하고
                  함께 발전시키는 동적인 플랫폼으로, 블록체인 분야의 권위자들이
                  연사로 참여하는 귀중한 기회였습니다. 특히, Vitalik Buterin의
                  발표는 이더리움의 비전과 미래 방향과 블록체인 기술의 발전
                  가능성을 볼 수 있었습니다.
                </h1>
                <h1>
                  ...
                  각자의 전문성을 바탕으로 심도 깊은 논의가 이루어졌습니다. ETH
                  Seoul 해커톤은 단순한 기술 경진대회를 넘어서, 블록체인 기술의
                  미래를 함께 고민하고 발전시킬 수 있는 중요한 장이었습니다.
                </h1>
              </li>
